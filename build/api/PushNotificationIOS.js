...
PushNotificationIOS=function(){_createClass(PushNotificationIOS,null,[{key:'__sendEvent__',value:function __sendEvent__(
type,data){
...
/**
   ...
   *
   */},{key:'presentLocalNotification',value:function presentLocalNotification(
details){
...
handler:function handler(notifData){
_handler(new PushNotificationIOS(notifData));
}};

}else if(type==='register'){
listener={
type:NOTIF_REGISTER_EVENT,
handler:function handler(registrationInfo){
_handler(registrationInfo.deviceToken);
}};
